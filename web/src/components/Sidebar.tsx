...
import { BookIcon, BoardsIcon } from "../lib/icons";

interface SidebarProps {
  className?: string;
}

// "Library" and "Boards" are real routes; "Sources > Browser Bookmarks"
// isn't (redesign spec section 8 explicitly allows this) -- it navigates to
// Library and scrolls to that section instead, via the same
